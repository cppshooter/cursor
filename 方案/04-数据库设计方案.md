...
[业务模块] --> [Qt SQL 模块]
[Qt SQL 模块] --> [QSqlDatabase]
[QSqlDatabase] --> [SQLite 驱动 (QSQLITE)]
[QSqlDatabase] --> [备选驱动 (DM/KingbaseES)]
[SQLite 驱动 (QSQLITE)] --> database "本地数据库文件"
[备选驱动 (DM/KingbaseES)] --> database "数据库实例"
@enduml
```
